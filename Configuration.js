...
function getEndpoints(deviceAddress, endpoints) {
   ...
   var a = endpoints.addEndpoint("1", "Channel A", endpointType.genericSensor);
    a.variableTypeId = 1309;
     var b = endpoints.addEndpoint("2", "Channel B", endpointType.genericSensor);
    b.variableTypeId = 1309;
